        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-cta">
              <a href="#demo" className="btn-primary">See the Difference</a>
              <a href="#problems" className="btn-secondary">Learn Why</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="cta-section" id="demo">
            ...
            <div className="hero-cta" style={{ justifyContent: 'center' }}>
              ...
              <a href="/" className="btn-secondary">Explore Omega</a>
            </div>
          </div>
        </div>
      </section>
