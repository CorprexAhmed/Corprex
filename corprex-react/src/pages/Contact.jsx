...
export default function Contact() {
  ...
  return (
    <>
      <HeadMeta title="Contact | Corprex" description="Talk to us about building private AI infrastructure with Omega." />
      <Nav active="contact" ctaHref="/contact" />
              ...
              <div className="info-section">
                ...
                <div className="info-items">
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h4>Phone</h4>
                      <p><a href="tel:+12027965245">(202) 796-5245</a></p>
                    </div>
                  </div>
                  <div className="info-item">
                    <svg className="info-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="section">
        <div className="container">
          <CTABanner title="Prefer a live walkthrough?" subtitle="Schedule a 1:1 demo and we’ll tailor it to your workloads" />
        </div>
      </section>
