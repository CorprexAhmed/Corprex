...
import LinkPreviewImage from '../components/LinkPreviewImage.jsx'
...
export default function News() {
  ...
  return (
    <>
      <HeadMeta title="News | Corprex" description="Latest on private AI, security, and infrastructure from trusted sources." />
      <Nav logoWeight={600} />
  ...
  return (
    <article className="article-card u-lift u-border-accent u-shadow-soft" onClick={onClick}>
      <div className="article-image">
        {img ? <img src={img} alt={title} /> : <LinkPreviewImage url={url} alt={title} />}
        {hostname && <span className="source-badge">{hostname}</span>}
      </div>
