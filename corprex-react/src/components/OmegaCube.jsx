...
export default function OmegaCube({ showPro = false, showOmega = true }) {
    ...
    >
      <div className="omega-core">
        <div className="omega-face front">
          ...
          {showOmega && <div className="omega-subtext">OMEGA</div>}
          {showPro && <div className="omega-pro-text">PRO</div>}
        </div>
        <div className="omega-face back">
          <div className="omega-logo-large">Ω</div>
          {showPro && <div className="omega-pro-text-back">PRO</div>}
        </div>
